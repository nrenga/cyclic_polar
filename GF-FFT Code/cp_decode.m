function [u,x] = cp_decode(y,f,q,omega,stage,N)
...
if (len == 1)
    ...
    [uhat1,u1hardprev] = cp_decode(u1est_permuted,f(:,1:(len/2)),q,omega,stage,N);
    ...
    [uhat2,u2hardprev] = cp_decode(u2est_permuted,f(:,(len/2+1):end),q,omega,stage,N);
